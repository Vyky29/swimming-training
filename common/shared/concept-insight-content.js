  ...
  var CURATED = {
    ...
    '1:b1c3': {
      ...
      pillars: [
        ...
        { icon: 'focus', title: 'Support → Control', text: 'Support can increase confidence, but it does not always lead to control.' }
      ]
    },
    '1:b1c4': {
    ...
    '1:b2c1': {
      ...
      pillars: [
        ...
        { icon: 'focus', title: 'Subtle Warning Signs', text: 'Risk often appears through subtle changes in position, response, or movement — stay continuously aware.' }
      ]
    },
    '1:b2c2': {
    ...
    '1:b3c2': {
      ...
      pillars: [
        ...
        { icon: 'focus', title: 'Observe Before Assuming', text: 'Swimmers may need more time to process and respond — observe sensory reactions before assuming readiness.' }
      ]
    },
    '1:b3c3': {
    ...
    '3:b1c3': { title: 'Connect Before You Teach', pillars: [
      ...
      { icon: 'balance', title: 'More Pressure → Learning', text: 'When engagement is low, more instruction often increases pressure instead of improving learning.' },
